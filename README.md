...
- `convex/auth.ts` uses the Password provider. Email verification is not enabled; new accounts are gated by admin activation instead (first user becomes an active admin, later sign-ups start disabled as operators).
